...
export function FieldReceivingAccount<T extends FieldValues>({
  name,
  ...
  const { data: receivingAccounts, isLoading } = trpc.transactionAccount.getAll.useQuery();

  if (isLoading) return <Skeleton className="h-10 w-full" />;

  const receivingAccountOptions: SelectOption[] =
